			...
			{!editMode && scamData && Object.keys(scamData).length > 0 && (
				<div className=" mx-auto w-[80%] grid grid-cols-2 h-[60vh] overflow-y-scroll justify-items-start">
					...
					<div className="  flex mb-[10px] flex-col ">
						...
						<div>
							{Object.values(scamData.bankAccountDetails).map((value, index) => (
								<p key={index}>{value}</p>
							))}
						</div>
					</div>
					<div className="  flex mb-[10px] flex-col ">
						...
						<div>
							{Object.values(scamData.website).map((input: string, index) => (
								<p key={index}>{input}</p>
							))}
						</div>
					</div>
					<div className="  flex mb-[10px] flex-col ">
						...
						<div>
							{Object.values(scamData.phoneNumber).map((input: string, index) => (
								<p key={index}>{input}</p>
							))}
						</div>
					</div>
					...
					<div className=" flex mb-[10px] flex-col ">
						...
						<div>
							{Object.values(scamData.socialMediaHandle).map((input: string, index) => (
								<p key={index}>{input}</p>
							))}
						</div>
					</div>
